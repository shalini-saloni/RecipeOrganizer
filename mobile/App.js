              ...
              <View style={styles.bottomNav}>
                ...
                <TouchableOpacity style={styles.navButton} onPress={() => setActiveScreen('home')}>
                  <Feather
                    name="home"
                    size={24}
                    color={activeScreen === 'home' ? '#F97316' : '#9CA3AF'}
                ...
                <TouchableOpacity style={styles.navButton} onPress={() => setActiveScreen('saved')}>
                  <Feather
                    name="bookmark"
                    size={24}
                    color={activeScreen === 'saved' ? '#F97316' : '#9CA3AF'}
                    style={styles.navIconSpacing}
                  />
                  <Text style={[styles.navLabel, activeScreen === 'saved' && styles.navLabelActive]}>
                    Saved
                  </Text>
                </TouchableOpacity>
                ...
                <TouchableOpacity
                  ...
                  onPress={() => setActiveScreen('ai_chef')}
                  activeOpacity={0.8}
                >
                ...
                <TouchableOpacity style={styles.navButton} onPress={() => setActiveScreen('upload')}>
                  <Feather
                    name="plus-circle"
                    size={24}
                    color={activeScreen === 'upload' ? '#F97316' : '#9CA3AF'}
                    style={styles.navIconSpacing}
                  />
                ...
                <TouchableOpacity style={styles.navButton} onPress={() => setActiveScreen('profile')}>
                  <Feather
                    name="user"
                    size={24}
                    color={activeScreen === 'profile' ? '#F97316' : '#9CA3AF'}
                    style={styles.navIconSpacing}
                  />
